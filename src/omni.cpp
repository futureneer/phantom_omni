...
class PhantomROS {
  ...
  geometry_msgs::PoseStamped omni_pose;
    ...
    void init(OmniState *s) 
    {
        ...
        omni_pose_publisher = n.advertise<geometry_msgs::PoseStamped>("omni_pose", 100);
        ...
        b_stream_gray << omni_name << "_button_gray";
        b_stream_white << omni_name << "_button_white";
        b_stream << omni_name << "_button";
        locked << omni_name << "_locked";
  ...
  //    void force_callback(const geometry_msgs::WrenchConstPtr& wrench)
    ...
    void publish_omni_state()
    {
        ...
        omni_internal_pose.pose.orientation.x = state->rot[0]+M_PI+.42;
        omni_internal_pose.pose.orientation.y = state->rot[1]+M_PI+.2;
